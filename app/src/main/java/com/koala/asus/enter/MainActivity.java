    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!account.getText().toString().equals("17023117")){
                    Toast.makeText(MainActivity.this,"没有找到该账号",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(!password.getText().toString().equals("password17023117")){
                    Toast.makeText(MainActivity.this,"请输入正确的密码",Toast.LENGTH_SHORT).show();
                    return;
                }
                Intent intent=new Intent(MainActivity.this,serondActivity.class);
